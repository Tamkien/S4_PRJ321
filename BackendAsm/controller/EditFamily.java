 ...
 * @author Tamkien
 */
@WebServlet(name = "EditFamily", urlPatterns = {"/EditFamily"})
public class EditFamily extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (((Account) request.getSession().getAttribute("user")) == null) {
            ...
            FamilyDAO idb = new FamilyDAO();
            Family i = idb.searchFamily(request.getParameter("famid"));
            request.setAttribute("family", i);
            request.getRequestDispatcher("edit-family.jsp").forward(request, response);
        }
    }
