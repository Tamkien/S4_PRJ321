 ...
 * @author Tamkien
 */
@WebServlet(name = "EditTravelHistory", urlPatterns = {"/EditTravelHistory"})
public class EditTravelHistory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (((Account) request.getSession().getAttribute("user")) == null) {
            ...
            request.getRequestDispatcher("edit-travelhistory.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        i.setPersonID(cmnd);
        i.setStatusID(stt);
        i.setTravelHistory(note);
        idb.editTravelHistory(i);
