 ...
 * @author Tamkien
 */
@WebServlet(name = "FamilyInfo", urlPatterns = {"/FamilyInfo"})
public class FamilyInfo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String famid = request.getParameter("id");
        FamilyDAO db = new FamilyDAO();
        Family f = db.searchFamily(famid);
        request.setAttribute("family", f);
        request.getRequestDispatcher("view-family.jsp").forward(request, response);
    }
